...
$ReportFile = $CurrentDate+"_ReceiveConnectorReport.csv"
$ReportPath = $ReportFolderValidated+$ReportFile

### Store the input CSV in a variable
Get-ReceiveConnector |
Select Server,Fqdn,Name,AuthMechanism,Enabled,MessageRateSource,RequireTLS,TransportRole,WhenChanged,WhenCreated |
