...
$ReportFile = $CurrentDate+"_UserReport.csv"
$ReportPath = $ReportFolderValidated+$ReportFile

### Gather list of all mail-enabled groups
Get-DistributionGroup -ResultSize Unlimited |
Select Name,GroupType,@{Name=”ManagedBy";Expression={$_.ManagedBy -Join “;”}},Alias,@{Name=”EmailAddresses";Expression={$_.EmailAddresses -Join “;”}},LegacyExchangeDN,PrimarySmtpAddress,RecipientType,RecipientTypeDetails,RequireSenderAuthenticationEnabled,Identity |
