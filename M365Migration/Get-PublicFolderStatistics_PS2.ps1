...
$ReportFile = $CurrentDate+"_PublicFolderStatistics.csv"
$ReportPath = $ReportFolderValidated+$ReportFile

### Retreive mailbox information
Get-PublicFolderStatistics -ResultSize Unlimited |
Select AdminDisplayName,Name,ContactCount,CreationTime,DeletedItemCount,FolderPath,LastAccessTime,LastModificationTime,OwnerCount,ItemCount,TotalItemSize,TotalAssociatedItemSize,TotalDeletedItemSize,DatabaseName |
