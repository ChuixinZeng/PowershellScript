...
$ReportFile = $CurrentDate+"_PublicFolderReport.csv"
$ReportPath = $ReportFolderValidated+$ReportFile

### Retreive mailbox information
Get-PublicFolder |
Select Name,ParentPath,HasSubFolders,HiddenFromAddressListsEnabled,MailEnabled,PerUserReadStateEnabled,UseDatabaseAgeDefaults,UseDatabaseQuotaDefaults,UseDatabaseReplicationSchedule,UseDatabaseRetentionDefaults,FolderType,HasRules,HasModerator,Identity |
